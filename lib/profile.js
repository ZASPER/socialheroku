...
var profileForm = forms.create({
  ...
  county: forms.fields.string(),
  zip: forms.fields.string(),
  bday: forms.fields.string(),
  colour: forms.fields.string()
});
...
function renderForm(req,res,locals){
  res.render('profile', extend({
    ...
    county: req.user.customData.county,
    zip: req.user.customData.zip,
    bday: req.user.customData.bday,
    colour: req.user.customData.colour
  },locals||{}));
}
  ...
  router.all('/', function(req, res) {
    profileForm.handle(req,{
      success: function(form){
        ...
        req.user.customData.county = form.data.county;
        req.user.customData.zip = form.data.zip;
        req.user.customData.bday = form.data.bday;
        req.user.customData.colour = form.data.colour;
